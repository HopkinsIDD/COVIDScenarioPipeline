...
if(!dir.exists(file.path(outdir,paste(dest,collapse='_')))){
  dir.create(file.path(outdir,paste(dest,collapse='_')),recursive=TRUE)
}
...
if(!dir.exists(file.path(config$spatial_setup$base_path,paste(dest,collapse='_')))){
  dir.create(file.path(config$spatial_setup$base_path,paste(dest,collapse='_')),recursive=TRUE)
}
