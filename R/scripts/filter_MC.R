...
option_list = list(
  ...
  optparse::make_option(c("-t", "--stoch_traj_flag"), action="store", default=Sys.getenv("COVID_STOCHASTIC_TRAJ",TRUE), type='logical', help = "Stochastic SEIR and outcomes trajectories if true"),
