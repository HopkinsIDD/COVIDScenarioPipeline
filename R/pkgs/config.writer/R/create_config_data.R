...
#' @param npi_cutoff_date interventions that start after npi_cuttof_date are removed 
#' @param v_dist type of distribution for value
#' @param v_mean value of perturbation mean
#' @param v_sd value of perturbation sd
#' @param v_a value of perturbation a
#' @param v_b value of perturbation b
#' @param inference logical indicating if inference will be performed on intervention (default is TRUE); perturbation values are replaced with NA if set to FALSE.
#' @param p_dist type of distribution for value
#' @param p_mean value of perturbation mean
#' @param p_sd value of perturbation sd
#' @param p_a value of perturbation a
#' @param p_b value of perturbation b
#'
...
#' @param sim_end_date simulation end date
#' @param v_dist type of distribution for value
#' @param v_mean vector perturbation mean for each month
#' @param v_sd value of perturbation sd
#' @param v_a value of perturbation a
#' @param v_b value of perturbation b
#' @param inference logical indicating if inference will be performed on intervention (default is TRUE); perturbation values are replaced with NA if set to FALSE.
...
set_seasonality_params <- function(sim_start_date=as.Date("2020-03-31"), 
    ...
    seas <- tidyr::expand_grid(
        ...
        dplyr::mutate(end_date = dplyr::if_else(end_date > sim_end_date, sim_end_date, end_date),
...
#' @param v_a value of perturbation a
#' @param v_b value of perturbation b
#' @param inference logical indicating if inference will be performed on intervention
#' @param p_dist type of distribution for value
#' @param p_mean value of perturbation mean
#' @param p_sd value of perturbation sd
#' @param p_a value of perturbation a
