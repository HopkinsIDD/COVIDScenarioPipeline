...
seir_chunk <- function(SEIR_source = c("R","W"),
    ...
    tmp <- paste0(
        ...
        ifelse(!is.null(vaccine_infector) & !is.na(vaccine_infector),
               paste0(
                   "      proportional_to: [\n", 
                   "        \"source\",\n", 
                   "        [\n",
                   ...
                   "          [[\"", paste0(variant_compartments_dest, collapse = "\"], [\""), "\"]],\n", 
               ...
               paste0(
                   ...
                   "      rate: [",rate_seir,", ", rate_vacc_parts,", ", rate_var_parts,", ", rate_age_parts,"]\n")), 
        "\n")
