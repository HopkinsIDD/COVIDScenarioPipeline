...
$I1, I2, I3$ in order to have an infectious period shaped as Ehrlang
...
The basic reproductive number, $R_0$, is drawn for each simulation in
range $2-3$, and we obtain parameter beta from
