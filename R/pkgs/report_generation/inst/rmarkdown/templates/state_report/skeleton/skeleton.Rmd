...
cap <- paste("**Fig. ", fig_counter, "**: Daily number of ICU beds needed for", nfiles2, "simulation realizations for", scen_desc_str, "at 1 % IFR assumptions. The horizontal line represents non-surge ICU bed capacity in California.")
fig_counter <- fig_counter+1
```
