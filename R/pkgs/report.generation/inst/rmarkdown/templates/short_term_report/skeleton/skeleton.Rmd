...
`r paste0("**Tab.", tab_counter, "**: State summary across ", length(config$report$formatting$display_dates), " time periods for 1% IFR assumptions.")`
...
`r paste0("**Tab.", tab_counter, "** Summary estimates across counties for the "format(short_start,"%B %d"),"-", format(short_end,"%B %d")," time period for all IFR assumptions.")`  
```{r county_tab_all}
