...
p2<-p2+theme(legend.position="none",
                ...
                plot.subtitle = element_text(size=18,
                                             face="bold"))+
    labs(subtitle=paste0(format(as.Date(display_dates)[1], "%B %d"), 
                         "-",
                         format(as.Date(display_dates)[2], "%B %d")))
...
p3<-p3+theme(legend.position="none",
                ...
                plot.subtitle = element_text(size=16,
                                             face="bold"))+
    labs(subtitle=paste0(format(as.Date(display_dates)[2], "%B %d"), 
                         "-",
                         format(as.Date(display_dates)[3], "%B %d")))
...
p4<-p4+theme(legend.position="none",
                ...
                plot.subtitle = element_text(size=18,
                                             face="bold"))+
    labs(subtitle=paste0(format(as.Date(display_dates)[3], "%B %d"), 
                         "-",
                         format(as.Date(display_dates)[4], "%B %d")))
