...
initialize_mcmc_first_block <- function(
  ...
  global_files <- create_filename_list(run_id, global_prefix, block - 1, global_types, extensions) # makes file names of the form variable/name/scenario/deathrate/run_id/global/intermediate/slot.(block-1).run_ID.variable.ext
  chimeric_files <- create_filename_list(run_id, chimeric_prefix, block - 1, chimeric_types, extensions) # makes file names of the form variable/name/scenario/deathrate/run_id/chimeric/intermediate/slot.(block-1).run_ID.variable.ext
