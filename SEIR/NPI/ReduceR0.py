...
class ReduceR0(NPIBase):
    def __init__(self, *, npi_config, global_config, geoids, loaded_df = None):
        ...
        if loaded_df is None:
            self.createFromConfig(npi_config)
        else:
            self.createFromDf(loaded_df)
    ...
    def createFromConfig(self, npi_config):
        ...
        # self.reductions = pd.DataFrame(0.0, index = self.affected_geoids)
    ...
    def createFromDf(self, loaded_df):
