...
class Parameters():
    ...
    def __init__(self, seir_config: confuse.core.Subview):
    ...
    def parameters_quick_draw(self, nt_inter: int, nnodes: int) -> np.ndarray:
        """
    ...
    def parameters_reduce(self, p_draw: np.ndarray, npi: object, dt: float) -> np.ndarray:
        """
    ...
    def parameters_write(self, p_draw: np.ndarray, fname: str, extension: str = 'parquet') -> pd.DataFrame:
    ...
    def parameters_load(self, fname: str, nt_inter: int, nnodes: int, extension: str = 'parquet',) -> np.ndarray:
        if extension == "csv":
