...
@click.command()
@click.option("-u", "--run_id", "run_id", required=True, envvar="COVID_RUN_INDEX", help="run_id_to convert from")
@click.option("-f", "--input_folder", "input_folder", required=True, help="Folder where the initial run is synced. There should be a model_ouput in it")
