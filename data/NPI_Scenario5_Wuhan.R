## create matrix for counties starting social distancing based on Wuhan R0 reductions
...
county.status$pc <- replicate(dim(county.status)[1], runif(dim(county.status)[1], 0.81, 0.89))
