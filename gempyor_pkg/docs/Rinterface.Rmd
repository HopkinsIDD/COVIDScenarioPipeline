...
gempyor_simulator$plot_transition_graph(output_file="readable_graph", source_filters= list(list("age0to17"), list("OMICRON", "WILD")), destination_filters= list(list("OMICRON", "WILD")))
