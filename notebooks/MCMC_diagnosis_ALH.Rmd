...
title: "R Notebook"
params:
  config_file: config_statelevel_2020.yml
  continue_on_error: yes
  hosp_eval: no
  pi_hi: 0.95
  pi_lo: 0.05
  runs_folder: model_output_2020_500 # directory with model output (i.e. with subdirs: hosp, snpi, spar)
  pdeath_default: "med"
...
# 
# # Only works if loading in county data
# # county<-geodata%>%
