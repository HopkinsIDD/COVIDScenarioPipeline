...
The code requires R version 3.6 or newer. You can download R from [cran](https://cran.rstudio.com/).  We also recommend [rstudio](https://rstudio.com/products/rstudio/download/), an R IDE.  We use packrat to manage packages. See the packrat directory, especially the packrat.lock file. For more information on how to use packrat, use the official packrat documentation.  You can source the script to install the versions required (the most recent versions also likely work).
