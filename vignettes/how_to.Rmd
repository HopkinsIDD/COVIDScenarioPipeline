...
%% POPULATE ME - Put some of the critical data/config pieces as well
...
%% POPULATE ME - mention that the R package link is also an installation script
...
# Hospitalization and Outcome Generator
